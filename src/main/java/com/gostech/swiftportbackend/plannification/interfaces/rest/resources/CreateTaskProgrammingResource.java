...
public record CreateTaskProgrammingResource(Long taskId, String resourceType, Long resourceId, String programmingStatus, LocalDateTime start, LocalDateTime end) {
