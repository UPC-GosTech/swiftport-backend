...
public record AddTaskProgrammingCommand(Long taskId, String resourceType, Long resourceId, LocalDateTime start, LocalDateTime end, String programmingStatus) {
